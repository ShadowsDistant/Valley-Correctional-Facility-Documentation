...
<CardGroup cols={2}>
  <Card title="Strengthening Our Team" icon="users">
    We have recently brought in a former Staff Manager from Valley Prison to help lead our Moderation and Specialized Investigations Divisions. We hope this increases community trust and ensures we hire the best.
  </Card>
  <Card title="Implementing Change" icon="hourglass-half">
    We have already started to implement many changes within our team, but this doesn't mean we are done. Over the coming weeks, you may experience some delays or holdups due to this transition.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Improve Community & Shift Quality">
    We are cracking down on fail roleplay and implementing the ban on religious roleplay.
  </Step>
</Steps>
