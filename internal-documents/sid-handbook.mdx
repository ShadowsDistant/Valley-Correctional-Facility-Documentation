...
| :---------------------------------- | :--------------------------------------------------------------------- |
| **Inactivity**                      | **1 Point**                                                            |
| **Inactivity (2 Months)**           | **5 Points** _(Triggers termination if previous inactivity was added)_ |
| **Failure to Follow Directive**     | **1-3 Points** _(Value determined by severity)_                        |
| **Failure to Moderate**             | **2-4 Points** _(Value determined by severity)_                        |
| **Failure to Uphold Standards**     | **1-3 Points** _(Value determined by severity)_                        |
...
<CardGroup cols={3}>
  <Card title="Point Expiration" icon="hourglass-end">
    To allow for staff improvement, points are not permanent. Each point will automatically expire **6 months** after the date it was issued.
  </Card>
