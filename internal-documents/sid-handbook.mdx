...
Punishments are progressive, ensuring fairness and proportionality. The Lead Investigator reserves the right to escalate or de-escalate actions based on the severity and intent of the violation.

| Violation                       | First Offense                                                                      | Second Offense                     | Third Offense |
| :------------------------------ | :--------------------------------------------------------------------------------- | :--------------------------------- | :------------ |
| **Inactivity**                  | Formal Verbal Warning                                                              | 7-Day Suspension                   | Termination   |
| **Failure to Follow Directive** | Formal Verbal Warning                                                              | 7-Day Suspension & Final Warning   | Termination   |
| **Failure to Moderate**         | Retraining & Verbal Warning                                                        | 7-Day Suspension & Written Warning | Termination   |
| **Biased Moderation**           | 7-Day Suspension & Final Warning                                                   | Termination & Blacklist            | N/A           |
| **Failure to Uphold Standards** | _Scales with severity_                                                             | _Escalation from First Offense_    | Termination   |
| **Mismanagement**               | 14-Day Suspension & Demotion                                                       | Termination                        | N/A           |
| **Command Abuse**               | _Minor/Negligent:_ 14-Day Suspension<br />_Major/Malicious:_ Immediate Termination | Termination & Blacklist            | N/A           |
| **Disclosure of Info**          | **Immediate Termination & Permanent Blacklist**                                    | N/A                                | N/A           |
