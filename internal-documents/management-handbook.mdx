...
As a manager, you are assigned a specific division to oversee. Each division has its own operations structure and specific duties that need to be completed. Below are some of the duties expected for all manager, along with managers for certain divisions.
