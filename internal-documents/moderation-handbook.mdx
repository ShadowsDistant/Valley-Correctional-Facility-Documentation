...
In-Game commands are permissions given by the shift host to all moderators attending the shift. Below is a list of command commands and when and how to use them correctly.
