...
<Card title="Baiting" icon="steak">
  ...
  - **Examples of violations:**
    ...
    - Purposefully doing an action to go to solitary without developing your character.
</Card>
...
<Card title="Interfering" icon="people">
  ...
  - **Examples of violations:**
    ...
    - Interjecting yourself into medical scenes in which you aren't apart of.
</Card>
