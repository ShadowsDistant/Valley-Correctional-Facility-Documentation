...
### Breaking Prison Property

Roleplay destroying or vandalizing prison property such as tables, chairs, benches, etc. Don't: unrealistically destroy property (i.e, destroying doors, AC units, etc).
...
### Disobeying Corrections Officers
...
- **Baiting**
  - Inmates are not allowed to _"bait"_ corrections personnel by committing illegal actions in front of them in an attempt to get a response.
- **Interfering**
...
- **Powergaming**
  - Players are not allowed to roleplay having a _"superior"_ character. This includes roleplaying that you cannot be knocked out in a fight, claiming your character is immune to fear roleplay, etc.
- **Metagaming**
...
Both IC (In-Character) and OOC (Out-Of-Character) can be used in shifts. When you are in character you are expected to be roleplaying or able to. When you are out of character you are placing yourself temporarly out of roleplay. Out of character should be used when chatting off topic in a shift. To signal that you are out of character we recommend souronding your message with ().

## Medical Roleplay

When in a medical roleplay scene you are not allowed to control the state and health of your character beyond inital context. This means you can't force your character to die or come back to life. If you require medical staff but none are avaliable you may choose to wait or respawn.