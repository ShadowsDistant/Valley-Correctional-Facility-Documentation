...
<Card title="When are shifts hosted?" icon="clock">
  Our shifts are normally hosted on weekends (Saturday-Sunday), but we may also host shifts on Friday. Shifts are hosted in the afternoon in Eastern Standard Time (EST).
</Card>
