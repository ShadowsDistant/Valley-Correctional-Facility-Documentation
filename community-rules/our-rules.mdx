...
<Warning>
  _"I haven't read the rules"_ is **NOT** an excuse for violating them. It's your responsibility to keep up-to-date on our rules.
</Warning>
...
# **Roblox Voice Chat (VC) Usage**

Voice Chat (VC) within the Roblox game is to be used for in-character communication ONLY and is considered a privilege. All conversations must be relevant to the ongoing roleplay situation.

- **What this means:** The in-game VC is an extension of the roleplay environment. Any communication over VC should be something your character would realistically say in their situation. Out-of-character (OOC) conversations must be held outside of the game.
- **Enforced In:** Shift
- **Examples of violations:**
  - Having a casual, out-of-character conversation with another player via VC.
  - Insulting another player OOC or arguing about rules using the in-game voice chat.
  - Using VC to coordinate actions based on out-of-character knowledge (metagaming).
