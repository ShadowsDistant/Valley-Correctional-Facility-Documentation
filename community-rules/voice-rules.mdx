...
keywords: ['VC rules', 'voice call rules', 'voice rules']
---
...
- **Procedure:**
  ...
  - **Violation Example:** A user starts a "Watch Together" session and plays videos for others without a moderator present to approve the content.