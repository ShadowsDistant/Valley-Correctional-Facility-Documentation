...
keywords: ['discord rules', 'chat rules']
---
...
- **Examples of violations:**
  - Posting a user's IP address (whether it's fake or not)
  - Posting a user's location (whether it's fake or not)
...
- **What this means:** This rule is to prevent harassment and unwanted private messages. Furthermore, please be aware that **the moderation team does handle reports from DMs**, but we will only take action against verifiable information that pertains to our community. And recommend that users use Discord's block feature before making a report.
...
- **What this means:** This includes sending unsolicited links to your YouTube channel, Twitch stream, personal Discord server, or any product you are selling. Attempting to recruit members from Valley Correctional Facility to another community ("poaching") is strictly forbidden, especially for other prison role-playing groups.
...
- **Examples of violations:**
  - Adding symbols or spaces to a slur.
...
<Warning>
  If you know of someone breaking this rule, you can be punished just as much as the person who has the material.
</Warning>

Members are prohibited from disclosing or claiming to possess classified or confidential information related to Valley Correctional Facility, whether or not the actual contents are shared. This also includes knowing about the possession of classified information by another member and not reporting it.

- **What this means:** Information about internal operations, staff discussions, chats within the DoC server are to be kept private to ensure fairness and smooth operations. Leaking this information, pretending to have it, or saying you've been sent it can create distrust and disrupt the community. This rule protects the integrity of our operations.
- **Examples of violations:**
  - Sharing screenshots from confidential channels (including the DoC server).
  - Publicizing in any channel that you have access to confidential information or have been sent it.
  - Hinting at sensitive staff discussions to cause drama or influence other members.
  - Discussing message contents that orginated from the DoC server.