...
<Card title="Fail Roleplay" icon="mask">
  ...
  - **Examples of violations:**
    ...
    - Resetting your character or leaving the game while in solitary.
</Card>
...
<Card title="Baiting" icon="steak">
  ...
  - **Examples of violations:**
    ...
    - Purposefully doing an action to go to solitary confinement without developing your character.
</Card>
...
<Card title="Interfering" icon="people">
  ...
  - **Examples of violations:**
    ...
    - Interjecting yourself into medical scenes in which you aren't a part of.
</Card>
...
<Card title="Powergaming" icon="fire">
  ...
  - **Examples of violations:**
    - **Forcing an action:** Instead of typing "_tackles the inmate and puts him in cuffs_," you should type "_attempts_ to tackle the inmate." This gives the other player a chance to roleplay their response.
...
<Card title="Metagaming" icon="laptop">
  ...
  - **Examples of violations:**
    ...
    - Seeing a CO's conversation by glitching your camera into a wall to gain intelligence as an inmate.
</Card>
...
<Card title="Non-Compliance" icon="person">
  ...
  - **What this means:** This rule is about moderator instructions, NOT in-character orders from a CO. When a staff member with an "Administrator" tag speaks to you in an OOC capacity (e.g., via private message or a staff command), their instruction is final and is meant to resolve a rule-breaking situation. An administrator may also be invisible, but can be identified by the yellow neon cuffs.
  - **Examples of violations:**
